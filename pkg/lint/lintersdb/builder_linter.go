...
import (
	...
	"github.com/mirecl/golangci-lint/v2/pkg/golinters"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/asasalint"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/asciicheck"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/bidichk"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/bodyclose"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/canonicalheader"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/containedctx"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/contextcheck"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/copyloopvar"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/cyclop"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/decorder"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/depguard"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/dogsled"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/dupl"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/dupword"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/durationcheck"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/err113"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/errcheck"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/errchkjson"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/errname"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/errorlint"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/exhaustive"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/exhaustruct"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/exptostd"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/fatcontext"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/forbidigo"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/forcetypeassert"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/funcorder"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/funlen"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/gci"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/ginkgolinter"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/gocheckcompilerdirectives"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/gochecknoglobals"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/gochecknoinits"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/gochecksumtype"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/gocognit"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/goconst"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/gocritic"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/gocyclo"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/godot"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/godox"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/gofmt"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/gofumpt"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/goheader"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/goimports"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/golines"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/gomoddirectives"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/gomodguard"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/goprintffuncname"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/gosec"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/gosmopolitan"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/govet"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/grouper"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/iface"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/importas"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/inamedparam"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/ineffassign"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/interfacebloat"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/intrange"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/ireturn"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/lll"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/loggercheck"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/maintidx"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/makezero"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/mirror"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/misspell"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/mnd"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/musttag"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/nakedret"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/nestif"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/nilerr"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/nilnesserr"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/nilnil"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/nlreturn"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/noctx"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/nolintlint"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/nonamedreturns"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/nosprintfhostport"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/paralleltest"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/perfsprint"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/prealloc"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/predeclared"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/promlinter"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/protogetter"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/reassign"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/recvcheck"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/revive"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/rowserrcheck"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/sloglint"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/spancheck"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/sqlclosecheck"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/staticcheck"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/tagalign"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/tagliatelle"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/testableexamples"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/testifylint"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/testpackage"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/thelper"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/tparallel"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/unconvert"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/unparam"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/unused"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/usestdlibvars"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/usetesting"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/varnamelen"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/wastedassign"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/whitespace"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/wrapcheck"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/wsl"
	"github.com/mirecl/golangci-lint/v2/pkg/golinters/zerologlint"
