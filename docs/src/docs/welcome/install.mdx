...
```bash
go install github.com/mirecl/golangci-lint/v2/cmd/golangci-lint@{.LatestVersion}
```
...
go get -tool -modfile=golangci-lint.mod github.com/mirecl/golangci-lint/v2/cmd/golangci-lint@{.LatestVersion}
```
...
go get -tool -modfile=golangci-lint.mod github.com/mirecl/golangci-lint/v2/cmd/golangci-lint@latest
```
...
```sh
# Add golangci-lint as a tool
go get -tool -modfile=golangci-lint/go.mod github.com/mirecl/golangci-lint/v2/cmd/golangci-lint
```
...
```sh
# Update golangci-lint
go get -tool -modfile=golangci-lint/go.mod github.com/mirecl/golangci-lint/v2/cmd/golangci-lint@latest
```
